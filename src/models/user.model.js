...
UserSchema.methods.isPasswordCorrect = async function(password){ // .methods is use to inject additional method for further usage related to Schema models
    return await bcrypt.compare(password,this.password) 
}

UserSchema.methods.generateAccessToken = function () {                 // This will be used for session and cookies for users
        return jwt.sign(                                                           // for creating tokens we will use jwt, provides .sign(                                                                
...
UserSchema.methods.generateRefreshToken = function () {                 // This will be used for session and cookies for users
        return jwt.sign(                                                           // for creating tokens we will use jwt, provides .sign(                                                                
            {                                                               //                                                      {payloaddata(userdata for generating token)}, 
                _id: this._id,                                              //                                                      SecretKey(secret key for encryption),                                      
            },                                                              //                                                      {expiresIn:}
